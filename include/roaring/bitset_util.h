...
inline static uint64_t avx2_harley_seal_popcount256(const __m256i* data, const uint64_t size) {
  ...
  total = _mm256_add_epi64(total, _mm256_slli_epi64(popcount256(eights), 3)); // += 8 * ...
  total = _mm256_add_epi64(total, _mm256_slli_epi64(popcount256(fours),  2)); // += 4 * ...
  total = _mm256_add_epi64(total, _mm256_slli_epi64(popcount256(twos),   1)); // += 2 * ...
  total = _mm256_add_epi64(total, popcount256(ones));
  for(; i < size; i++)
    total = _mm256_add_epi64(total, popcount256(_mm256_lddqu_si256(data + i)));
...
static inline uint64_t avx2_harley_seal_popcount256_##opname(const __m256i* data1,\
    ...
    uint64_t i = 0;\
	for(; i < limit; i += 16) {\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i),  _mm256_lddqu_si256(data2 + i));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 1),  _mm256_lddqu_si256(data2 + i + 1));\
		CSA(&twosA, &ones, ones,A1, A2);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 2),  _mm256_lddqu_si256(data2 + i + 2));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 3),  _mm256_lddqu_si256(data2 + i + 3));\
		CSA(&twosB, &ones, ones, A1, A2);\
		CSA(&foursA, &twos, twos, twosA, twosB);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 4),  _mm256_lddqu_si256(data2 + i + 4));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 5),  _mm256_lddqu_si256(data2 + i + 5));\
		CSA(&twosA, &ones, ones, A1, A2);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 6),  _mm256_lddqu_si256(data2 + i + 6));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 7),  _mm256_lddqu_si256(data2 + i + 7));\
		CSA(&twosB, &ones, ones, A1, A2);\
		CSA(&foursB,& twos, twos, twosA, twosB);\
		CSA(&eightsA,&fours, fours, foursA, foursB);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 8),  _mm256_lddqu_si256(data2 + i + 8));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 9),  _mm256_lddqu_si256(data2 + i + 9));\
		CSA(&twosA, &ones, ones, A1, A2);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 10),  _mm256_lddqu_si256(data2 + i + 10));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 11),  _mm256_lddqu_si256(data2 + i + 11));\
        CSA(&twosB, &ones, ones, A1, A2);\
		CSA(&foursA, &twos, twos, twosA, twosB);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 12),  _mm256_lddqu_si256(data2 + i + 12));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 13),  _mm256_lddqu_si256(data2 + i + 13));\
		CSA(&twosA, &ones, ones, A1, A2);\
		A1 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 14),  _mm256_lddqu_si256(data2 + i + 14));\
		A2 = avx_intrinsic( _mm256_lddqu_si256(data1 + i + 15),  _mm256_lddqu_si256(data2 + i + 15));\
		CSA(&twosB, &ones, ones, A1, A2);\
		CSA(&foursB, &twos, twos, twosA, twosB);\
		CSA(&eightsB, &fours, fours, foursA, foursB);\
		CSA(&sixteens, &eights, eights, eightsA, eightsB);\
