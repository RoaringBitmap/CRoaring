#ifndef ROARING_INCLUDE_ROARING_ARRAY_H
#define ROARING_INCLUDE_ROARING_ARRAY_H
...
enum {
    ROARING_SERIAL_COOKIE_NO_RUNCONTAINER = 12346,
    ROARING_SERIAL_COOKIE = 12347,
    ROARING_NO_OFFSET_THRESHOLD = 4
};
