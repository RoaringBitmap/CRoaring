...
def topaddedversionstring(major, minor, rev):
    return str(major).zfill(2)+"."+str(minor).zfill(3)+"."+str(rev).zfill(3)
...
with open(versionfile, 'w') as file:
    ...
    file.write("#define ROARING_VERSION_NUMBER "+topaddedversionstring(*newversion)+"  \n")
    file.write("#define ROARING_VERSION_MAJOR "+str(newversion[0])+"  \n")
    file.write("#define ROARING_VERSION_MINOR "+str(newversion[1])+"  \n")
    file.write("#define ROARING_VERSION_REVISION "+str(newversion[2])+"  \n")
