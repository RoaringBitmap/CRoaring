...
inline int32_t array_container_get_nruns(const array_container_t *c) { (void) c; return -1; }
inline int32_t bitset_container_get_nruns(const bitset_container_t *c) { (void) c; return -1; }
inline int32_t run_container_get_nruns(const run_container_t *c) { return c->n_runs; }
...
int main(int argc, char* argv[]) {
    ...
    BENCHMARK_CONTAINER(run, array, run_container_equals_array, DEFAULT_MAX_SIZE);
    BENCHMARK_CONTAINER(array, bitset, array_container_equal_bitset, DEFAULT_MAX_SIZE);
    BENCHMARK_CONTAINER(run, bitset, run_container_equals_bitset, DEFAULT_MAX_SIZE);
