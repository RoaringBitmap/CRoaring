...
bool array_container_equal_bitset(array_container_t * container1, bitset_container_t * container2) {
...
bool run_container_equals_array(run_container_t * container1, array_container_t * container2){
...
bool run_container_equals_bitset(run_container_t * container1, bitset_container_t * container2){
	if(container2->cardinality != BITSET_UNKNOWN_CARDINALITY) {
		...
		int32_t card =
	        bitset_container_compute_cardinality(container2);  // modify container2?
