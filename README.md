...
- Recent C compiler supporting the C11 standard (GCC 4.8 or better or clang 9), there is also an optional C++ class that requires a C++ compiler supporting the C++11 standard.
