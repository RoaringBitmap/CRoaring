...
Vanishingly few people have big-endian systems. Yet we support big-endian systems such as the IBM s390x.
But big-endian systems are not interoperable with big-endian systems (see [issue 423](https://github.com/RoaringBitmap/CRoaring/issues/423)).
